...
1. To replicate this results of this project you need to create a conda environment using 
...
All hyperparameters needed for running the script, could be found in the `congif.json`.
